...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url()?>dist/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
 ...
 <a href="">SELAMAT DATANG</a>
  ...
  <div class="register-box-body">
    ...
    <form action="<?php echo base_url()?>index.php/authentication/auth/simpan" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="Nohp" placeholder="No Handphone" data-inputmask='"mask": "(999) 999-9999"' data-mask>
      </div>
...
<br>
    ...
    <a href="<?php echo base_url()?>index.php/authentication/auth/login" class="text-center">Anda Sudah Mempunyai Akun?</a>
  </div>
  <!-- /.form-box -->
</div>
...
<!-- bootstrap color picker -->
<script src="<?php echo base_url()?>dist/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
