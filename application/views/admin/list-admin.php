      ...
      <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                 ...
                 <li><a href="<?php echo base_url()?>index.php/admin/client/client"><i class="fa fa-user-o"></i> CLIENT  <span class="label label-primary pull-right"><?php echo $client ?></span></a></li>
                </li>
...
<div class="box">
    ...
    <?php
        ...
        <tr>
              ...
              <td>
                  <!-- KARENA SUPER BISA HAPUS ADMIN MANA SAJA< MAKA HILANGKAN FILTERNYA --->
                  <center>
                    <a  onclick="return confirm('Apa Anda Yakin Hapus Data?')" style="width: 80px" class="btn btn-danger" href="<?php echo base_url()?>index.php/admin/client/hapus/<?php echo $row->id?>"><i class='fa fa-trash-o'> Hapus</i></a>
                  </center>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal_edit_user">
          ...
          <form method="post" action="<?php echo base_url() ?>index.php/admin/data_admin/edit">
                    <div class="form-group">
             <div class="input-group">
              <div class="input-group-addon">
                <b>ID ADMIN</b>
