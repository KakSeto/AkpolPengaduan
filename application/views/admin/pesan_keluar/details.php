...
<a target="_BLANK" class="btn btn-danger btn-block margin-bottom" href="<?php echo base_url()?>index.php/admin/read/struck/<?php echo $id_laporan ?>"><i class="fa fa-print"></i> Cetak  </a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo base_url()?>index.php/admin/read"><i class="fa fa-envelope-o"></i> LAPORAN KELUAR   <span class="label label-primary pull-right"><?php echo $pesan_keluar ?></span></a></li>
                </li>
                <li><a href="<?php echo base_url()?>index.php/admin/hapus"><i class="fa fa-trash-o"></i> Trash <span class="label label-danger pull-right"><?php echo $hapus ?></span></a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
          ...
          <div class="form-group">
            ...
            <div class="box-footer">
              <div class="pull-right">
                <a href="<?php echo base_url()?>index.php/admin/read"  class="btn btn-primary"><li class="fa fa-home" >  Kembali</li></a>
                </div>
            </div>
            <!-- /.box-footer -->
          </div>
