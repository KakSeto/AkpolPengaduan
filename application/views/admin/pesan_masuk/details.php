 <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-md-3">
<a target="_BLANK" class="btn btn-danger btn-block margin-bottom" href="<?php echo base_url()?>index.php/admin/laporan/struck/<?php echo $id_laporan ?>"><i class="fa fa-print"></i> Cetak  </a>
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="<?php echo base_url()?>index.php/admin/laporan"><i class="fa fa-inbox"></i> LAPORAN MASUK
                ...
                <li><a href="<?php echo base_url()?>index.php/admin/hapus"><i class="fa fa-trash-o"></i> Trash   <span class="label label-danger pull-right"><span class="label label-danger pull-right"><?php echo $hapus ?></span></a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
    ...
    <div class="col-md-9">
     ...
     <form method="POST" action="<?php echo base_url()?>index.php/admin/laporan/simpan/<?php echo $id_laporan ?>" >
         <?php
              $no =  1 ;
