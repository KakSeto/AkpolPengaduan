...
<div class="modal fade" id="modal-default">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url()?>index.php/admin/jenis/simpan" method="post">
          </div>
          <!-- /.box-header -->
  ...
  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-default">
    ...
    <?php
          ...
          <td> <center>
         <a  onclick="return confirm('Apa Anda Yakin Hapus Data?')" href="<?php echo base_url()?>index.php/admin/jenis/hapus/<?php echo $row->id_jenis?>">  <i class="fa fa-trash-o btn btn-danger"> Hapus</i></a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal_edit_jenis">
          <form method="post" action="<?php echo base_url();?>index.php/admin/jenis/simpan">
                    <div class="form-group">
             <div class="input-group">
              <div class="input-group-addon">
                <b>ID JENIS</b>
