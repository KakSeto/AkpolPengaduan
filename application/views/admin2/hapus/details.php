          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="<?php echo base_url()?>index.php/admin2/read"><i class="fa fa-envelope-o"></i> LAPORAN KELUAR   <span class="label label-primary pull-right"><?php echo $pesan_keluar ?></span></a></li>
                </li>
                <li class="active"><a href="<?php echo base_url()?>index.php/admin2/hapus"><i class="fa fa-trash-o"></i> Trash <span class="label label-danger pull-right"><?php echo $hapus ?></span></a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
          ...
          <div class="form-group">
            ...
            <div class="box-footer">
              <div class="pull-right">
                <a href="<?php echo base_url()?>index.php/admin2/hapus"  class="btn btn-primary"><li class="fa fa-home" >  Kembali</li></a>
                </div>
            </div>
            <!-- /.box-footer -->
          </div>
