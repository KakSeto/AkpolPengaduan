...
<form method="POST" action="<?php echo base_url()?>index.php/admin2/home/update">
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Halaman</b> ADMIN 2</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
     ...
     <?php
                 ...
                 <li>
                    <a href="<?php echo base_url()?>index.php/admin2/laporan/view/<?php echo $row->id_laporan ?>">
                      <div class="pull-left">
