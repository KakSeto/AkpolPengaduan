...
<form method="POST" action="<?php echo base_url()?>index.php/admin2/cover/simpan/<?php echo $row->id_cover ?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modal-profil">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
   <form method="POST" action="<?php echo base_url()?>index.php/admin2/profil_akpol/simpan?username=<?php echo $user=$this->session->userdata('username'); ?>">
...
<div class="modal fade" id="modal-default">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
    <form method="POST" action="<?php echo base_url()?>index.php/admin2/info/tambah" enctype="multipart/form-data" >
            ...
            <tbody>
              ...
              foreach ($data->result() as $row) { 
                ...
                <tr>
                  ...
                  <td>
  <a  onclick="return confirm('Apa Anda Yakin Hapus Data?')" class='btn btn-danger' href='<?php echo base_url()?>index.php/admin2/info/hapus/<?php echo $row->id ?>' ><i class='fa fa-trash-o' ></i> Hapus </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal_edit_info">
          ...
          <form method="post" action="<?php echo base_url() ?>index.php/admin2/info/simpan">
                    <div class="form-group">
             <div class="input-group">
              <div class="input-group-addon">
                <b>ID INFO</b>
