...
<table class="table table-bordered table-striped">
  ...
  <td><a href="<?php echo base_url()?>index.php/client/info/view/<?php echo $row->id ?>" class="btn btn-success"> Lihat</a></td>
 ...
 <div class="box box-info">
            ...
            <div class="box-body">
                           <form action="<?php echo base_url() ?>index.php/client/cetak/hasil" methode="POST">

  <div class="form-grup">
    <input type="text"  name="search" class="form-control" placeholder="Nomor Laporan">
<br>
