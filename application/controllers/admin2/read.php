...
public function index()
	{
		...
		$isi['content'] = 'admin2/pesan_keluar/view';
		...
		$isi['data']	= $this->model_jawab->viewdata($departemen);
	...
	public function read_view()
	{
		...
		$isi['content'] = 'admin2/pesan_keluar/details';
...
if($query->num_rows()== 0){
	...
	{
		$this->model_scurity->getscurity();
		$isi['content'] = 'admin2/pesan_keluar/cetak';
		$isi['label'] = 'cetak';
		$this->load->model('admin2/model_laporan');
		$departemen = $this->session->userdata('Departemen');
		// Count
